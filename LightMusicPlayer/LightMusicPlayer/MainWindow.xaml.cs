...
using LightMusicPlayer.Helpers;
...
namespace LightMusicPlayer
{
    ...
    public partial class MainWindow
    {
        ...
        private void LoadExpressionDarkTheme()
        {
            ...
            Resources.MergedDictionaries.Clear();
            ResourceDictionary themeResources = Application.LoadComponent(new Uri("Skins/ExpressionDark.xaml", UriKind.Relative)) as ResourceDictionary;
            Resources.MergedDictionaries.Add(themeResources);
        }
